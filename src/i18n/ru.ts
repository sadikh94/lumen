...
const ru: Translations = {
  ...
  'Mobile navigation order': 'Порядок вкладок на мобильном',
  'New home interface': 'Новый интерфейс главной страницы',
  'Episode updates in Recent': 'Обновления серий в «Досмотреть»',
  'Show the episode update button in the top-right corner of Recent.': 'Показывать кнопку обновления серий в правом верхнем углу вкладки «Досмотреть».',
  'Move Settings to Home and allow sorting or hiding the Account tab.': 'Переместить настройки на главную страницу и разрешить сортировку или скрытие вкладки аккаунта.',
  ...
  'Show bookmark counts': 'Показывать количество закладок',
  'Show how many votes a rating is made of, next to it.': 'Рядом с рейтингом будет показано кол-во голосов.',
  'Show the number of films in each bookmark category.': 'Показывать количество фильмов в каждой категории закладок.',
  ...
  'Home display mode': 'Режим отображения главной',
  'Bookmarks display mode': 'Режим отображения закладок',
  'Recent display mode': 'Режим отображения «Досмотреть»',
  'Grid': 'Плитка',
  'List': 'Список',
  ...
  'Compact season and episode selector': 'Компактный выбор сезона и серии',
  'Use dropdowns instead of buttons to choose the season and episode.': 'Использовать выпадающие списки вместо кнопок для выбора сезона и серии.',
  ...
  'Scroll to top button': 'Кнопка прокрутки наверх',
  'Show a floating button to jump back to the top after scrolling down.': 'Показывать плавающую кнопку для быстрого возврата наверх после прокрутки вниз.',
  'Corner of the screen the floating scroll-to-top button appears in.': 'Угол экрана, в котором появляется плавающая кнопка прокрутки наверх.',
