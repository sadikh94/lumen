...
const en = {
  ...
  'Orange': 'Orange',
  'Red': 'Red',
  'TV navigation order': 'TV navigation order',
  'Mobile navigation order': 'Mobile navigation order',
  'New home interface': 'New home interface',
  'Episode updates in Recent': 'Episode updates in Recent',
  'Show the episode update button in the top-right corner of Recent.': 'Show the episode update button in the top-right corner of Recent.',
  'Move Settings to Home and allow sorting or hiding the Account tab.': 'Move Settings to Home and allow sorting or hiding the Account tab.',
  ...
  'Show bookmark counts': 'Show bookmark counts',
  'Show how many votes a rating is made of, next to it.': 'Show how many votes a rating is made of, next to it.',
  'Show the number of films in each bookmark category.': 'Show the number of films in each bookmark category.',
  ...
  'Home display mode': 'Home display mode',
  'Bookmarks display mode': 'Bookmarks display mode',
  'Recent display mode': 'Recent display mode',
  'Grid': 'Grid',
  'List': 'List',
  ...
  'Compact season and episode selector': 'Compact season and episode selector',
  'Use dropdowns instead of buttons to choose the season and episode.': 'Use dropdowns instead of buttons to choose the season and episode.',
